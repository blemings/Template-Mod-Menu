...
using static Template.Classes.RigManager;
    ...
    public class Safety
    {
        ...
        public static void AntiReport(System.Action<VRRig, Vector3> onReport)
        {
            ...
            foreach (GorillaPlayerScoreboardLine line in GorillaScoreboardTotalUpdater.allScoreboardLines)
            {
                ...
                foreach (var vrrig in from vrrig in GorillaParent.instance.vrrigs where !vrrig.isLocal let D1 = Vector3.Distance(vrrig.rightHandTransform.position, report.position) let D2 = Vector3.Distance(vrrig.leftHandTransform.position, report.position) where D1 < 2f || D2 < 2f select vrrig)
